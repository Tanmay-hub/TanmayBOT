        ...
        {isAboutOpen && (
          <div className="modalOverlay">
            <div className="modalContent">
              ...
              <p>
                1) My name is Tanmay Bothra, and I am looking for full-time roles or internships in software engineering, data science, or analytics. TanmayBOT is a chatbot personification of me that can answer questions about my work experience, projects, education, and skills. Responses are generated by a Large Language Model (LLM) that has access to a knowledge base with details about my life and background.
              </p>
              <p>
                2) While any information provided by TanmayBOT will be accurate, please note that it does not have access to every detail about me and may not be able to answer all questions. The style and personality of the LLM-generated responses should not be assumed to be identical to my own.
              </p>
            ...
            {messages.length === 0 ? (
              <div className="emptyState">
                ...
                <p className="emptyText">
                  ...
                  work experience, skills, education, or interests!
                </p>
              </div>
            ) : (
